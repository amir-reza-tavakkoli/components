...
export let ChatMessage = defineComponent({
    template: `
        <article aria-atomic="true" id="#1" class="chat-message" aria-label="Message from username1 at 12:30 on @date">
...
export let ChatMessageRight = defineComponent({
    template: `
        <article id="#1" class="chat-message-2" aria-label="Already sent message from you at 12:30 on @date">
