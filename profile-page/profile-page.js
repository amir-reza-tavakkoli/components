...
export let ProfilePage = defineComponent({
    ...
    <nav aria-label="Related items to Username1">
        <ul>
            <li>
                <button type="button">
                    <span class="novisual">All</span>
                    MEDIA
                    <span class="novisual">from username1</span>
                </button>
            </li>
            <li>
                <button type="button">
            ...
            <li>
                <button type="button">
                    <span class="novisual">All</span>
                    LINKS
                    <span class="novisual">Shared by username1</span>
                </button>
            </li>
            <li>
                <button type="button">
            ...
            <li>
                <button type="button">
                    <span class="novisual">All</span>
                    VOICE
                    <span class="novisual">Records from username1</span>
                </button>
            </li>
            <li>
                <button type="button">
                    <span class="novisual">All</span>
                    <span class="novisual">Mutual</span>
                    GROUPS
                </button>
            </li>
        </ul>
